  ...
  return (
    <div className="relative w-full max-w-[428px] h-[926px] mx-auto bg-white rounded-[35px] overflow-hidden">
      ...
      <p className="absolute top-[194px] left-[24px] w-[380px] text-[14px] leading-[28px] font-medium text-[#1F2937]">
        Discover skilled professionals closest to your
        location in seconds.
      </p>
      ...
      {/* Next Button */}
          <button
        onClick={goToChat}
        className="absolute top-[754px] left-[24px] w-[380px] h-[52px] flex items-center justify-center bg-[#008000] rounded-full"
      >
